 ...
 */
export function findEndpointDefinition(document: vscode.TextDocument, endpointName: string): vscode.Location | null {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (endpointPattern.test(line)) {
            ...
            if (nameMatch) {
                ...
                const endPosition = new vscode.Position(i, startIndex + nameMatch[1].length);
